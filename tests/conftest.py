...
from fastapi_amazon_q_dev.db.utils import create_database, drop_database
from fastapi_amazon_q_dev.settings import settings
from fastapi_amazon_q_dev.web.application import get_app
...
async def _engine() -> AsyncGenerator[AsyncEngine, None]:
    ...
    from fastapi_amazon_q_dev.db.models import load_all_models
